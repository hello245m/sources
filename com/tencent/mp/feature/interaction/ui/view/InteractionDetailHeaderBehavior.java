...
public final class InteractionDetailHeaderBehavior extends CoordinatorLayout.c<View> {
    ...
    public InteractionDetailHeaderBehavior(Context context, AttributeSet attributeSet) {
    }
