...
public abstract class BaseMediaPlayer {
    ...
    public abstract void setAudioStreamType(int i2) throws IllegalStateException;
    ...
    public abstract void setWakeMode(Context context, int i2) throws IllegalStateException, UnSupportMethodException;
